...
import FriendRequestSidebarOption from './FriendRequestSidebareOption'
...
interface MobileChatLayoutProps {
    ...
    unseenFriendReqs: number
}

const MobileChatLayout: FC<MobileChatLayoutProps> = ({ friends, session, sidebarOptions, unseenFriendReqs }) => {
